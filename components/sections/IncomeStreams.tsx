  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {streams.map((s) => (
            <FeaturedCard key={s.title} stream={s} />
          ))}
        </motion.div>
...
function FeaturedCard({ stream }: { stream: typeof streams[0] }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        ...
        {stream.link && (
          <a
            ...
            style={{ fontSize: "0.78rem", fontWeight: 600, color: "var(--accent)", display: "inline-flex", alignItems: "center", gap: "0.3rem", padding: "0.4rem 0.9rem", border: "1px solid rgba(196,98,45,0.3)", borderRadius: "999px", transition: "background 0.2s ease", textDecoration: "none", whiteSpace: "nowrap" }}
      ...
      <p style={{ fontSize: "0.88rem", color: "var(--muted)", lineHeight: 1.75, flex: 1 }}>
        {stream.description}
      </p>
