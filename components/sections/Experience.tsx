...
const experiences = [
  {
    ...
    description:
      "Founded and run a digital agency helping local businesses grow online. Build websites, AI automations, and brand strategies end-to-end.",
  ...
  },
  {
    ...
    period: "2024 – Present",
    description:
      "Built and grew a content brand in the EAFC gaming niche. Developed the brand website, grew a Discord community, and built a custom bot.",
